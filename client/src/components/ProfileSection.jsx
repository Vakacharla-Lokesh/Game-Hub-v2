        ...
        {team.map((member, index) => (
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-lg text-white italic mb-1">{member.role}</p>
              ...
              <div className="flex gap-6 text-yellow-300 text-2xl">
                ...
                <a href={member.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                  <FaInstagram />
                </a>
                <a href={`mailto:${member.email}`} className="hover:text-white transition">
                  <FaEnvelope />
                </a>
              </div>
            </div>
