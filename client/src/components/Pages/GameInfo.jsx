  ...
  useEffect(() => {
    const loadGameDetails = async () => {
      try {
        ...
        setSimilarGames([
          { id: 1, title: "Epic Adventure", image_url: "https://via.placeholder.com/300x200", rating: 4.8, category: "Adventure", isHot: true },
          { id: 2, title: "Space Warrior", image_url: "https://via.placeholder.com/300x200", rating: 4.6, category: "Action", isNew: true },
          { id: 3, title: "Puzzle Master", image_url: "https://via.placeholder.com/300x200", rating: 4.9, category: "Puzzle" },
          { id: 4, title: "Racing Thunder", image_url: "https://via.placeholder.com/300x200", rating: 4.7, category: "Racing", isHot: true },
          { id: 5, title: "Magic Quest", image_url: "https://via.placeholder.com/300x200", rating: 4.5, category: "RPG" },
          { id: 6, title: "Cyber Strike", image_url: "https://via.placeholder.com/300x200", rating: 4.8, category: "Action", isNew: true },
          { id: 7, title: "Ocean Explorer", image_url: "https://via.placeholder.com/300x200", rating: 4.4, category: "Adventure" },
          { id: 8, title: "Sky Pilot", image_url: "https://via.placeholder.com/300x200", rating: 4.6, category: "Simulation" },
          { id: 9, title: "Battle Arena", image_url: "https://via.placeholder.com/300x200", rating: 4.7, category: "Strategy" },
        ]);
      } catch (err) {
      ...
      <main className="relative z-10 px-6 py-8">
        ...
        <div className="relative overflow-hidden rounded-3xl mb-12 border border-white/10 shadow-2xl group">
          ...
          <div className="absolute bottom-8 left-8 flex items-center gap-3 bg-black/90 backdrop-blur-md rounded-2xl px-8 py-4 border border-yellow-400/60 shadow-2xl">
            <Star className="w-7 h-7 text-yellow-400 animate-pulse" fill="currentColor" />
            <span className="text-white text-2xl font-black tracking-wide">{game.rating}</span>
            <span className="text-gray-300 text-base font-medium">/5.0</span>
          </div>
        ...
        <section className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="group flex items-center gap-4 p-6 bg-gradient-to-r from-purple-900/20 to-violet-900/20 border border-purple-400/30 rounded-2xl backdrop-blur-sm hover:border-purple-300/50 transition-all duration-300 transform hover:scale-105">
              ...
              <div>
                <p className="text-sm text-purple-300 font-semibold uppercase tracking-wider">Category</p>
                <p className="font-black text-xl text-white">{game.category || "N/A"}</p>
              </div>
            </div>
            ...
            <div className="group flex items-center gap-4 p-6 bg-gradient-to-r from-blue-900/20 to-cyan-900/20 border border-blue-400/30 rounded-2xl backdrop-blur-sm hover:border-blue-300/50 transition-all duration-300 transform hover:scale-105">
              ...
              <div>
                <p className="text-sm text-blue-300 font-semibold uppercase tracking-wider">Genre</p>
                <p className="font-black text-xl text-white">{game.genre || "N/A"}</p>
              </div>
            </div>
            ...
            <div className="group flex items-center gap-4 p-6 bg-gradient-to-r from-orange-900/20 to-red-900/20 border border-orange-400/30 rounded-2xl backdrop-blur-sm hover:border-orange-300/50 transition-all duration-300 transform hover:scale-105">
              ...
              <div>
                <p className="text-sm text-orange-300 font-semibold uppercase tracking-wider">Players</p>
                <p className="font-black text-xl text-white">{game.players || "Single/Multiplayer"}</p>
              </div>
            </div>
          </div>
              ...
              {similarGames.slice(0, visibleGames).map((similarGame) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <button className="w-full bg-gradient-to-r from-purple-600/80 to-violet-600/80 text-white font-bold py-3 rounded-xl hover:from-purple-500 hover:to-violet-500 transition-all duration-300 transform hover:scale-105">
                      Play Now
                    </button>
                  </div>
                </div>
